...
// Routine to read an uncompressed 24-bit unindexed color RGB BMP 
//file into a 32-bit color RGBA image file
//(alpha values all being set to 1).
...
imageFile *getBMP(std::string fileName){
	...
	// Allocate storage for temporary input file, read in image data from the BMP file, 
	//close input stream.
